...
public class Gato extends AnimalAB {
    ...
    public void scanComida() {
        ...
        System.out.print("Digite a quantidade de comida ingerida pelo Gato: ");
        comidaIngerida = scanner.nextInt();
    }

    public void scanCaminho() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Digite a quantidade de caminho percorrido pelo Gato: ");
        caminhoPercorrido = scanner.nextInt();
    }

    public void scanHoras() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Digite a quantidade de horas dormidas pelo Gato: ");
